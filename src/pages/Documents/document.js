...
import { UserOutlined, FileAddOutlined, FileFilled, FilePdfFilled, FilePdfOutlined, FolderOpenOutlined, LinkOutlined, CopyOutlined, DragOutlined, FolderAddOutlined, StarOutlined, SearchOutlined, PlusOutlined, HistoryOutlined, DeleteOutlined, SortAscendingOutlined } from '@ant-design/icons';
...
const menuAdd = (
    <Menu onClick={handleClick}>
        <Menu.Item key="1" icon={<FolderAddOutlined />}>Thư mục</Menu.Item>
        <Menu.Item key="2" icon={<FileAddOutlined />}>Tệp</Menu.Item>
    </Menu>
...
const menuFolder = (
    <Menu onClick={handleClick}>
        ...
        <Menu.Item key="4" icon={<CopyOutlined />}>Sao chép</Menu.Item>
        <Menu.Item key="5" icon={<DragOutlined />}>Di chuyển</Menu.Item>
        <Menu.Item key="6" icon={<DeleteOutlined />}>Xóa</Menu.Item>
    </Menu>
);
    ...
    return (
        <Layout>
            <Header style={styleHeader} className="header">
                ...
                <Row>
                    <Col span={8}>
                        <Menu style={styleHeader} mode="horizontal" defaultSelectedKeys={['4']}>
            ...
            <Layout>
                <Card>
                    <Sider width={350} style={styleSider}>
                        <Form.Item name="Search" style={{ width: '90%' }}>
                            <Input placeholder="Tìm kiếm " prefix={<SearchOutlined />} /></Form.Item>
                        ...
                        <Menu theme="light" defaultActiveKey="1">
                            <Menu.Item key="1" icon={<StarOutlined />}>Được đánh dấu sao</Menu.Item>
                            <Menu.Item key="2" icon={<HistoryOutlined />}>Gần đây</Menu.Item>
                            <Menu.Item key="3" icon={<DeleteOutlined />}>Thùng rác</Menu.Item>

                            <Popover content={menuSort} placement="bottom">
                                <Menu.Item key="4" icon={<SortAscendingOutlined />}>Sắp xếp</Menu.Item>
                            </Popover>
                        </Menu>
                    </Sider>
                </Card>
                ...
                <Card style={{ width: '100%', minHeight: 1000 }}>
                    <Content style={styleContent}>
                        ...
                        <Tabs defaultActiveKey="1" size='large' type="card" onChange={callback}>
                            ...
                            <TabPane tab="Tệp" key="2">
                                <Row gutter={[24, 24]}>
                                    <Col span={6}>
                                        <Popover content={menuFolder} placement="left" trigger="click">
                                            {detailFolder}
                                        </Popover>
                                    </Col>
                                    ...
                                    <Col span={6}>
                                        <Popover shape="round" content={menuFolder} placement="left" trigger="click">
                                            {detailFolder}
                                        </Popover>
                                    </Col>
                                </Row>
